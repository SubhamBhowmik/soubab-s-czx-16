      ...
      <main class="container">
        <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          <div class="col-lg-6 px-0">
            <h1 class="display-4 fst-italic">Select tour list</h1>
            <p class="lead my-3">
            ...
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow h-md-250 position-relative">
              <div class="col p-4 d-flex flex-column position-static">
                <strong class="d-inline-block mb-2 text-primary-emphasis">
                  Guide: Abc tour guide
                </strong>
                <h2 class="mb-0">Tour in jampui hill</h2>
                <div class="mb-0 text-body-secondary fw-bold">
                  Journey day: Nov 12 to Dec 1
                </div>
                <div class="mb-2 text-danger fw-bolder">
                  Last day to apply: Nov 12 to Dec 1
                </div>
                <p class="card-text mb-auto">
                  Description about the journey hugug ygug gygyg fyy gugug ufug
                  escription about the journey hugug ygug gygyg fyy gugug ufug
                </p>

                <div class="d-flex justify-content-between mt-1">
                  <h6 class="mb-auto">Fee: Rs: 200/-</h6>
          ...
          <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow h-md-250 position-relative">
              <div class="col p-4 d-flex flex-column position-static">
                ...
                <p class="card-text mb-auto">Description about the journey</p>
                <a
                  href="#"
                  class="icon-link gap-1 icon-link-hover stretched-link"
                >
          ...
          <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              <div class="col p-4 d-flex flex-column position-static">
                ...
                <p class="mb-auto">
                  This is a wider card with supporting text below gygyg ugug ug
                  ugug ug ug ydf tgu fuifiufifi t iugi fgiuyg as a natural
                  lead-in to additional content.
                </p>
                <a
                  href="#"
